...
function addSchematicFiles(appProjectRoot, options) {
    return schematics_1.chain([
        ...
        schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
            schematics_1.template(Object.assign(Object.assign({}, options), { offsetFromRoot: workspace_1.offsetFromRoot(options.appProjectRoot) })),
    ...
    return (host) => {
        return schematics_1.chain([
            ...
            workspace_1.updateJsonInTree(`${options.appProjectRoot}/tsconfig.app.json`, json => {
                return Object.assign(Object.assign({}, json), { extends: `./tsconfig.json`, compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { outDir: `${workspace_1.offsetFromRoot(options.appProjectRoot)}dist/out-tsc` }), exclude: options.enableIvy
                        ? undefined
                        : options.unitTestRunner === 'jest'
                            ? ['src/test-setup.ts', '**/*.spec.ts']
                            : ['src/test.ts', '**/*.spec.ts'], include: options.enableIvy ? undefined : ['src/**/*.d.ts'] });
            }),
            host => {
    ...
    return (host) => {
        ...
        return schematics_1.chain([
            ...
            workspace_1.updateJsonInTree(`${options.e2eProjectRoot}/tsconfig.e2e.json`, json => {
                return Object.assign(Object.assign({}, json), { extends: `./tsconfig.json`, compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { outDir: `${workspace_1.offsetFromRoot(options.e2eProjectRoot)}dist/out-tsc` }) });
            })
        ]);
    };
}
...
function normalizeOptions(host, options) {
    ...
    return Object.assign(Object.assign({}, options), { prefix: options.prefix ? options.prefix : defaultPrefix, name: appProjectName, appProjectRoot,
        e2eProjectRoot,
        e2eProjectName,
        parsedTags });
}
