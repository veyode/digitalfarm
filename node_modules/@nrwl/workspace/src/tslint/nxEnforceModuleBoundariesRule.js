...
class EnforceModuleBoundariesWalker extends Lint.RuleWalker {
    ...
    visitImportDeclaration(node) {
        ...
        if (imp.startsWith(`@${this.npmScope}/`)) {
            ...
            if (runtime_lint_utils_1.isCircular(this.projectGraph, sourceProject, targetProject)) {
            ...
            // cannot import apps
            if (targetProject.type !== project_graph_2.ProjectType.lib) {
            ...
            if (this.enforceBuildableLibDependency === true &&
                sourceProject.type === project_graph_2.ProjectType.lib &&
                targetProject.type === project_graph_2.ProjectType.lib) {
                if (runtime_lint_utils_1.hasArchitectBuildBuilder(sourceProject) &&
                    ...
                    this.addFailureAt(node.getStart(), node.getWidth(), 'buildable libs cannot import non-buildable libs');
                    return;
                }
            }
