...
const options_1 = require("@angular-devkit/schematics/tasks/node-package/options");
        ...
        if (packageName === '@nrwl/workspace') {
            ...
            m.packageJsonUpdates[targetVersion + '-defaultPackages'] = {
                ...
                packages: [
                    ...
                    '@nrwl/tao',
                    '@nrwl/web'
                ].reduce((m, c) => (Object.assign(Object.assign({}, m), { [c]: { version: targetVersion, alwaysAddToPackageJson: false } })), {})
            };
        }
...
function versions(root, from) {
    return (packageName) => {
        try {
            ...
            const content = fs_1.readFileSync(path_1.join(root, `./node_modules/${packageName}/package.json`));
    ...
    return function f(packageName, packageVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!cache[`${packageName}-${packageVersion}`]) {
                ...
                const json = JSON.parse(stripJsonComments(fs_1.readFileSync(path_1.join(dir, 'node_modules', packageName, 'package.json')).toString()));
                ...
                try {
                    if (migrationsFile && typeof migrationsFile === 'string') {
                        const json = JSON.parse(stripJsonComments(fs_1.readFileSync(path_1.join(dir, 'node_modules', packageName, migrationsFile)).toString()));
