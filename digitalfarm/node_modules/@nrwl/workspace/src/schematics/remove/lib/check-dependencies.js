...
function checkDependencies(schema) {
    ...
    return (tree) => {
        ...
        const graph = project_graph_1.createProjectGraph(ast_utils_1.readWorkspace(tree), ast_utils_1.readNxJsonInTree(tree), files, file => tree.read(file).toString('utf-8'), false, false);
